  ...
  return (
    ...
    >
      ...
      <div className="w-full">
        ...
        >
          <div className="bg-blue-400 z-30 items-center p-2 text-white rounded-full">
            <svg
                ...
                {product?.image.map((img, index) => (
                  <button key={index} onClick={() => setSelectedImage(img)}>
                    <Image
                      ...
                      width={100}
                      height={100}
                      className="lg:w-24 lg:h-16 max-lg:h-20 max-lg:w-full border-2 border-blue-400 object-cover rounded-lg"
                    />
                  </button>
                ))}
              </div>
      ...
      <button
        ...
        title="Toggle theme"
        className={`fixed bottom-[90px] lg:right-20 max-lg:right-8 z-40 p-3 rounded-full bg-blue-400 ${
