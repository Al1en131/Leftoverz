  ...
  return (
    ...
    >
      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        ...
        />
        <div className="lg:flex lg:justify-between max-lg:justify-center max-lg:w-full z-20 items-center lg:pt-48 max-lg:pt-40 lg:pb-16 max-lg:pb-14 lg:px-20 max-lg:px-6 max-lg:text-center text-left">
        ...
        <div className="relative w-full text-[#080B2A] dark:text-white shadow-md">
          ...
          <Image
            ...
            alt=""
            src="/images/Star-1.svg"
            className="w-4 absolute top-20 lg:left-40 max-lg:left-14 -z-0"
          />
          <Image
            width={100}
            height={100}
