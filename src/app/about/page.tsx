...
export default function About() {
  // Di dalam komponen yang mengatur toggle theme
  ...
  // Pada saat komponen mount, sinkronkan tema dari localStorage
  useEffect(() => {
  ...
  return (
    <div className={`items-center ${theme === 'dark' ? 'dark:bg-[#080B2A]' : 'bg-white'} min-h-screen`}>
      <main className="">
        <Image
          width={100}
          height={100}
        ...
        <button
          ...
          title="Toggle theme"
          className="fixed bottom-6 lg:right-20 max-md:right-8 z-50 p-2 rounded-full bg-blue-400 dark:text-white text-[#080B2A]"
        >
          {theme === "dark" ? (
            <svg
