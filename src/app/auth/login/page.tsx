...
export default function Login() {
  ...
  return (
    <div
      className={`min-h-screen flex items-center justify-center lg:px-6 ${
    ...
    >
      ...
      />
      <div
        className={`w-full max-w-6xl flex flex-col lg:bg-white/10 lg:flex-row items-center justify-center lg:justify-between gap-10 rounded-2xl max-lg:p-6 lg:p-14 ${
          theme === "dark" ? "border-0" : "lg:border-[2px] lg:border-blue-400"
        } ${theme !== "dark" ? "" : ""}`}
      >
        <div className="w-full lg:w-1/2 bg-blue-950/10 border-2 border-blue-400 rounded-lg shadow-lg max-lg:p-6 lg:p-12">
          <h1
            className={`text-xl font-bold mb-6 tracking-wide lg:text-2xl ${
