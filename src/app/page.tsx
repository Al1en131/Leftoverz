...
export default function Home() {
  ...
  return (
    <div className=" bg-white dark:bg-[#080B2A]  items-center justify-items-center min-h-screen ">
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        ...
        <div className="lg:flex lg:justify-between max-lg:justify-center max-lg:w-full z-20 items-center lg:pt-36 max-lg:pt-28 lg:pb-24 lg:px-20 max-lg:px-6 max-lg:text-center text-left">
          <div className="lg:w-1/2 max-lg:w-full block lg:space-y-4 max-lg:space-y-1 z-20">
            ...
            <p className="lg:text-4xl max-lg:text-xl dark:text-white text-[#080B2A] font-bold z-20">
              Barang Bekas Kos dengan Harga Terjangkau dan Kualitas Terjamin
            </p>
            <p className="text-lg max-lg:text-base dark:text-white text-[#080B2A] leading-6 z-20">
            ...
            <div className="flex gap-4 pt-4 max-lg:justify-center">
              ...
              <Link
                href="/auth/login"
                className="border-[#15BFFD] text-[#15BFFD] max-lg:py-1 max-lg:px-3 border-2 lg:w-36 bg-transparent px-4 py-3 rounded-full text-center hover:bg-[#15BFFD] hover:dark:text-white"
              >
                Login
              </Link>
            </div>
        ...
        <div className="lg:justify-between max-lg:justify-center lg:px-20 max-lg:px-6 max-lg:py-6 max-lg:space-y-4 lg:flex max-lg:block items-center relative lg:mb-10 max-lg:mb-0 w-full">
          ...
          />
          <div className="absolute inset-0 dark:bg-white bg-blue-400 dark:opacity-5 opacity:20 z-10"></div>
          <div className="relative z-50 lg:w-2/4 max-lg:w-full dark:text-white text-[#080B2A] max-lg:text-center max-lg:justify-center">
            <h4 className="lg:text-5xl max-lg:text-4xl font-bold pb-4 dark:text-white text-[#080B2A]">
              Why Choose Us?
            </h4>
            <p className="text-lg max-lg:text-justify mb-6 dark:text-white text-[#080B2A]">
            ...
            <Link
              href="/about"
              className="dark:bg-[#15BFFD] bg-white px-4 mt-4 py-3 text-center dark:text-white text-[#080B2A] w-36 rounded-full hover:bg-transparent hover:text-[#15BFFD] hover:border-2 hover:border-[#15BFFD]"
            >
              About Us
            </Link>
          </div>
        ...
        <div className="lg:p-20 max-lg:p-6 w-full relative">
          ...
          <div className="text-center justify-center z-50">
            <h3 className="text-3xl font-bold dark:text-white text-[#080B2A]">
              Features
            </h3>
            <p className="dark:text-white text-[#080B2A]">
              Lorem Ipsum is simply dummy text of the printing and typesetting
              industry
            </p>
            <div className="lg:pt-14 max-lg:pt-8 lg:flex lg:justify-between max-lg:justify-center max-lg:w-full max-lg:block max-lg:space-y-4 items-center">
              <div className="border_section bg-transparent h-[350px] dark:text-white text-[#080B2A] rounded-xl p-5 lg:w-80 max-lg:w-full shadow-lg relative">
                <Image
                  width={100}
                  height={10}
                  alt=""
                ...
                <div className="mt-4 h-1/4">
                  <p className="text-lg font-semibold dark:text-white text-[#080B2A]">
                    Pencarian Visual
                  </p>
                </div>
              </div>
              ...
              <div className="lg:px-20 max-lg:px-6 space-y-10">
                <div className="relative lg:flex max-lg:justify-center max-lg:w-full lg:justify-end">
                  <div className="relative lg:w-[580px] max-lg:-w-full p-5 text-[#080B2A] rounded-2xl border_style shadow-md bg-white/5">
                    ...
                    <p className="dark:text-white text-[#080B2A] text-lg">
              ...
              >
                <div className="mb-4 flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    <span className="w-9 h-9 bg-blue-400 rounded-full flex items-center justify-center dark:text-white text-[#080B2A]">
                      {product.seller?.name
                        ? product.seller?.name
                            .split(" ")
                  ...
                  <Link
                    ...
                    className="bg-blue-400 px-4 py-1 text-center dark:text-white text-[#080B2A] rounded-lg hover:bg-transparent z-20 hover:text-blue-400 hover:border-2 hover:border-bluetext-blue-400"
                  >
                    Detail
                  </Link>
                </div>
                ...
                <div className="mt-4">
                  <h3 className="dark:text-white text-[#080B2A] text-lg font-bold">
                    {product.name}
                  </h3>
        ...
        <button
          type="button"
          className="cursor-pointer bg-blue-400 dark:text-white text-[#080B2A] fixed bottom-6 lg:right-20 max-md:right-8 z-50 hover:bg-hover-background active:bg-active-background rounded-full border border-button-border-color p-2 [transition:background_20ms_ease-in,_color_0.15s]"
          title="Toggle theme"
        ...
        >
          ...
          <svg
            ...
            height="15"
            fill="none"
            className="hidden w-7 h-7 dark:block"
          >
            <path
