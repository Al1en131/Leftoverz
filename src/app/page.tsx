  ...
  return (
    ...
    >
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        ...
        />
        <div className="lg:flex lg:justify-between max-lg:justify-center max-lg:w-full z-20 items-center lg:pt-36 max-lg:pt-32 lg:pb-16 max-lg:36 lg:px-20 max-lg:px-6 max-lg:text-center text-left">
